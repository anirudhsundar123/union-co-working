...
<body>
    <nav class="navbar navbar-light navbar-expand-md d-xl-flex align-items-xl-center navigation-clean-button navbar-fixed-top">
        <div class="container"><a class="navbar-brand" href="#">Page</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse d-xl-flex align-items-xl-center"
                ...
                <form method="post"><span class="d-xl-flex align-items-xl-center navbar-text actions"> <button data-bs-hover-animate="swing" class="login" type="submit" style="color: #FF3F3F; border:none; background-color: white;" name="logout">LOGOUT</button></span></form></div>
                <?php
    ...
    <div class="container">
        <h1 style="margin-top: 15px;"><strong>Cart</strong></h1>
        <p style="color: rgba(0,0,0,0.5);">Add or modify content of the cart.</p>
        <hr>
    </div>
    <div class="container">
        <?php 
            include("cartPhp.php"); 
            displayCart($_SESSION['suname']);
        ?>
        <?php 
        if(checkCartCheckout($_SESSION['suname'])){
            echo'
            <form method="POST">
            <div class="form-group d-inline">
                <div class="" style="margin-top:10px; margin-bottom:20px; width:100%; ">
                    <button class="btn btn-primary  btn-block" type="submit" name="checkout" style="background-color: red; border-color: rgba(0,0,0,0); width:100%; ">
